...
class LessonPlanBanner extends StatelessWidget {
  const LessonPlanBanner({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: size.width * 9,
      constraints: BoxConstraints(maxWidth: 850, maxHeight: 155),
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text:
                          'Easily create structured lesson plans aligned \nwith',
                    ),
                    WidgetSpan(
                      child: SizedBox(
                        width: 8,
